...
subroutine get_cheby(lss, lrad, cheby)
  ...
  real(REAL_KIND),intent(in) :: lss
  integer, intent(in) :: lrad
  real(REAL_KIND), intent(inout) :: cheby(0:lrad,0:1)
...
subroutine get_cheby_d2(lss, lrad, cheby)
  ...
  real(REAL_KIND),intent(in) :: lss
  integer, intent(in) :: lrad
  real(REAL_KIND), intent(inout) :: cheby(0:lrad,0:2)
...
subroutine get_zernike(r, lrad, mpol, zernike)
  ...
  real(REAL_KIND), intent(inout) :: zernike(0:lrad,0:mpol,0:1)

  real(REAL_KIND) ::    rm, rm1  ! r to the power of m'th and m-1'th
  real(REAL_KIND) ::    factor1, factor2, factor3, factor4
...
subroutine get_zernike_d2(r, lrad, mpol, zernike)
  ...
  real(REAL_KIND),intent(in) :: r
  integer, intent(in) :: lrad, mpol
  real(REAL_KIND), intent(inout) :: zernike(0:lrad,0:mpol,0:2)

  real(REAL_KIND) ::    rm, rm1, rm2  ! r to the power of m'th, m-1'th and m-2'th
  real(REAL_KIND) ::    factor1, factor2, factor3, factor4
  integer :: m, n  ! Zernike R^m_n
...
subroutine get_zernike_rm(r, lrad, mpol, zernike)
  ...
  real(REAL_KIND),intent(in) :: r
  integer, intent(in) :: lrad, mpol
  real(REAL_KIND), intent(inout) :: zernike(0:lrad,0:mpol)
